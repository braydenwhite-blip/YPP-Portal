...
import { FollowUpWorkspace } from "@/components/command-center";
...
export const metadata = {
  title: "Follow Up — Pathways Portal",
};
...
export default async function FollowUpPage() {
  ...
  const vm = buildFollowUpWorkspace({ engine, now });

  return <FollowUpWorkspace vm={vm} />;
}
