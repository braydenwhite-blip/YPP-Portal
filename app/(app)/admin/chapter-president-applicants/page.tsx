  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
      ...
      <div style={{ display: "flex", gap: 3 }}>
        {[1, 2, 3, 4, 5].map((n) => (
          <div key={n} style={{ width: 10, height: 10, borderRadius: 2, background: score != null && n <= score ? "#6b21c8" : "var(--surface-2)", border: "1px solid var(--border)" }} />
        ))}
      </div>
                      ...
                      <details style={{ border: "1px solid var(--border)", borderRadius: 8, padding: "10px 14px" }}>
                        ...
                        <div style={{ marginTop: 10 }}>
                          <p style={{ fontSize: 13, color: "var(--muted)", marginTop: 0 }}>
                            Scheduling now lives in the shared interview scheduler so booking, reminders, and reschedules stay in one workflow.
                          </p>
