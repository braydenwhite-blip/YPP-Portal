  ...
  return (
    <div
      ...
      style={{
        flex: 1,
        minWidth: "260px",
        borderTop: isQuarterly ? `3px solid var(--ypp-purple-500)` : `3px solid ${ratingCfg.color}`,
      }}
    >
          ...
          {review.goalRatings.map((gr) => {
            ...
            return (
              <div key={gr.goalTitle} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.2rem" }}>
                ...
                <span style={{ fontSize: "0.7rem", color: grCfg.color, fontWeight: 600, whiteSpace: "nowrap" }}>
                  {grCfg.label}
                </span>
              </div>
            );
