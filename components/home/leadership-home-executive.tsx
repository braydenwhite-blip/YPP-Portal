...
/**
 * Leadership Home — the EXECUTIVE view (Knowledge OS V2, plan §7/§27.6). The
 * full operating picture: Today's Brief, the cross-domain attention queue (with
 * reasons), upcoming meetings, overdue actions, applicants needing a decision,
 * and the unified timeline. Every tile is a real count linking into its filtered
 * list; no pulse scores, no charts, no vague panels (§19). The calm front door
 * is in ./leadership-home-calm; this is what Executive mode shows.
 */
