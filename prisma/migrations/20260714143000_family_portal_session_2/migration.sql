...
CREATE TABLE "FamilySupportResponse" (
    ...
    "authorUserId" TEXT,
    "body" TEXT NOT NULL,
    "responseType" TEXT NOT NULL DEFAULT 'FAMILY_VISIBLE',
...
CREATE TABLE "FamilyFormRequirement" (
    ...
    "programId" TEXT,
    "dueAt" TIMESTAMP(3),
    "blocksEnrollment" BOOLEAN NOT NULL DEFAULT false,
    "blocksAttendance" BOOLEAN NOT NULL DEFAULT false,
    "staffReviewRequired" BOOLEAN NOT NULL DEFAULT false,
