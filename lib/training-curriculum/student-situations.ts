    ...
    // -------------------------------------------------------------------------
    {
      ...
      config: {
        ...
        correctFeedback: {
          ...
          consequence: "You walk into your next workshop with the loop in mind.",
          roomDelta: { clarity: 1 },
        },
      },
    },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      config: {
        ...
        correctFeedback: {
          ...
          consequence: "You're starting to read the room before it dips.",
          roomDelta: { engagement: 1, clarity: 1 },
        },
        incorrectFeedback: {
          default: {
            tone: "incorrect",
            ...
            consequence: "A few quiet drop-offs slip past you.",
            roomDelta: { clarity: -1 },
          },
        },
      },
        ...
        incorrectFeedback: {
          ...
          default: {
            ...
            studentReaction: {
              ...
              archetype: "shy",
              mood: "shutdown",
              bodyLanguage: "no response, eyes off-camera",
            },
            consequence: "Maya stays frozen.",
        ...
        incorrectFeedback: {
          ...
          default: {
            ...
            studentReaction: {
              ...
              archetype: "distracted",
              mood: "checked-out",
              bodyLanguage: "still nodding, not really there",
            },
            consequence: "Diego stays at the edge of the room.",
            roomDelta: { engagement: -1 },
          },
        },
      },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      config: {
        ...
        correctFeedback: {
          ...
          consequence: "Your next disengagement gets handled with a wait, not a lecture.",
        ...
        incorrectFeedback: {
          default: {
            ...
            consequence: "You over-correct early and burn the room's patience.",
            roomDelta: { energy: -1 },
          },
        },
      },
