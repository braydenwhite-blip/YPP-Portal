...
export const HELP_AGENT_SUGGESTIONS: HelpAgentSuggestion[] = [
  ...
  // --- CPO / People & Performance review queue (Leadership) ---
  {
  ...
  {
    label: "What chapters need help?",
    description: "Chapters needing support, at risk, or with no upcoming meeting",
    href: "/admin/chapters?view=needs_support",
    icon: "🏘",
    tier: "OFFICER",
    adminOnly: true,
    kind: "query",
  ...
  {
    label: "Chapters with no upcoming meeting",
    description: "Operating chapters with nothing on the calendar",
    href: "/admin/chapters?view=no_upcoming_meeting",
    icon: "🗓️",
    tier: "OFFICER",
    adminOnly: true,
    kind: "query",
