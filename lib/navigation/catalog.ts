...
export const NAV_CATALOG: NavLink[] = [
  ...
  ...groupLinks("Chapters", 900, [
    ...
    },
    {
      ...
      dashboardPriority: 2,
      searchAliases: ["Students", "Student Roster", "Chapter Students", "Find students"],
    },
    {
      ...
      coreEligible: true,
      dashboardDescription:
        "See every instructor in your chapter, their classes, and open their profile to manage them.",
      dashboardPriority: 3,
      searchAliases: [
        "Instructors",
        "Chapter Instructors",
    ...
    },
    {
      ...
      roles: ["ADMIN", "STAFF"] as NavRole[],
      coreEligible: true,
      dashboardDescription: "Launch, support, and manage every chapter across the national pipeline — including goals and analytics.",
      dashboardPriority: 3,
      searchAliases: [
        "Chapter Command",
        "Chapter Directory",
