...
describe("resolveNavModel", () => {
  ...
  it("keeps admin users on Home, People, Mentorship, Actions, and Applicants", () => {
    const model = resolveNavModel({
      roles: ["ADMIN"],
      primaryRole: "ADMIN",
      pathname: "/",
  ...
  it("pins Home, People, Mentorship, Actions, and Applicants for staff", () => {
    const model = resolveNavModel({
      roles: ["STAFF"],
      primaryRole: "STAFF",
      pathname: "/",
  ...
  describe("public preview slim nav", () => {
    ...
    it("shows Home, People, Mentorship, Actions, and Applicants for admins", () => {
      const model = resolveNavModel({
        roles: ["ADMIN"],
        adminSubtypes: ["SUPER_ADMIN"],
        primaryRole: "ADMIN",
...
describe("officer section navigation (simple leadership IA)", () => {
  ...
  it("shows only Home, People, Mentorship, Actions, and Applicants", () => {
...
describe("chapter-president section navigation", () => {
  ...
  it("gives chapter presidents Home, People, Mentorship, Actions, and Applicants", () => {
    const model = cpModel();
